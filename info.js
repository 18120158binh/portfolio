let info = {
  name: "Ly Ngoc Binh",
  logo_name: "Ly Ngoc Binh",
  flat_picture: require("./src/assets/sky_sunset.gif"),
  config: {
    use_cookies: true,
    navbar: {
      blur: false
  ...
  myself: "My Vietnamese name is Ly Ngoc Binh, Chinese name is 孙嘉仪 (Sūn Jiāyí), and English name is Rose Sun.",
  description:
    "I am a Data Engineer with 3 years of experience designing and developing end-to-end ETL pipelines, ensuring Data Quality, and integrating data with backend systems. Skilled in Spark, Kafka, Airflow, and API development for Data Platform. Passionate about data modeling and platform architecture, with a strong interest in expanding expertise in real-time data systems.",
  links: {
    linkedin: "https://www.linkedin.com/in/ngocbinh-ly/",
    github: "https://github.com/18120158binh",
...
//    }
  ...
  experience: [
    {
      name: "The Center of Applied Data Science - FPT Corporation",
      place: "Ho Chi Minh city, Viet Nam",
      ...
      sub: [
        {
          title: "Project A",
          description: "Developed data ingestion pipelines for IoT data."
        },
        {
          title: "Project B",
          description: "Implemented real-time analytics for customer data."
        }
      ]
    },
    {
  ...
  skills: [
    ...
    },
    {
      ...
      info: ["Vue", "FastAPI", "Flask"],
      icon: "fas fa-laptop-code"
    },
    {
      title: "databases",
      info: ["Clickhouse", "Postgres", "StarRocks", "Neo4j"],
      icon: "fa fa-database"
    },
    {
    ...
    {
      title: "design",
      info: ["Data pipeline", "data architecture", "data model"],
